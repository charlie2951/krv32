...
# =================================================================
set PROJECT_NAME "krv32_soc_nexys4ddr_qspi"
...
set MEM_FILE_DIR "./src/mem_nexys4ddr_flash"
...
# Adding clock generation IP 
source create_clk_ip.tcl
...
set rtl_files [list \
    $RTL_DIR/top_nexys4ddr_qspi.v \
    $RTL_DIR/cpu_nexys4ddr.v \
...
set SDC_FILE_PATH "./src/Nexys4DDR_Master.xdc"
...
set mcs_file "$PROJECT_DIR/$PROJECT_NAME.runs/impl_1/nexys4ddr_flash.mcs"
set flash_size "16"
set interface "SPIx1"
