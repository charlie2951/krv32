...
# =================================================================
set PROJECT_NAME "krv32_soc_basys3_qspi"
...
set rtl_files [list \
    $RTL_DIR/top_basys3_qspi.v \
    $RTL_DIR/cpu_basys3.v \
...
set SDC_FILE_PATH "./src/Basys-3-Master-qspi.xdc"
...
set mcs_file "$PROJECT_DIR/$PROJECT_NAME.runs/impl_1/basys3_flash.mcs"
set flash_size "16"
set interface "SPIx1"
