### UART Readback demo
This demo code is used to read the value of character pressed in PC keyboard and display the same in UART console. Tested on `TeraTerm` and
`Putty` as Serial terminal application.
```
