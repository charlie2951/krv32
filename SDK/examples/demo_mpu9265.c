   ...
   printf("AccX, AccY, AccZ | GyroX, GyroY, GyroZ | MagX, MagY, MagZ | Temp('C)\r\n");
    ...
    while(1) {
      ...
      /*
        ...
        uart_sendline(UART1,"\r\n"); */
      printf("x_accel:%d, y_accel:%d, z_accel:%d, g_x:%d, g_y=%d, g_z=%d, m_x=%d, m_y=%d, m_z=%d, Temp=%d.%d", x_accel,y_accel,z_accel,g_x,g_y,g_z,m_x,m_y,m_z,sensor.temp_c/10,sensor.temp_c%10);
        // Dummy delay
        delay(500000);
    }
    return 0;
