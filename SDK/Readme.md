...
### Useful C functions
`delay(unsigned int count)`  Provides a common delay function, not optimized for clock frequency variation. At 27MHz Clock, each count provides approx. 1uS delay. <p>
