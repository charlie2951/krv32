/* Interfacing Winbond W25Q series flash using hardware SPI
-ID Read, page erase, page write, and read demonstrated.
Author: Subir Maity
School of Electronics Engg, KIIT University, Bhubaneswar, India.
*/
#include "uart.h"
#include "spi.h"
#include "w25q.h"
