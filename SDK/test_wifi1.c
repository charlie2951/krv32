...
void transmit_data(int temperature, int pressure)
{
    ...
    my_strcat(sendData,"&field1=25.43");//dummy data 25.43 in payload to test connection
...
int main()
{
	...
	setup_esp8266();
   while(1){
    transmit_data(temperature,sensor2_val);//send 2 sensor data to adafruit cloud
    delay(10000000);
   }
   return 0;
}